...
class SAC(object):
    def __init__(self, obs_dim, action_dim, action_range, batch_size, args):
        ...
        critic_config = agent_cfg.critic_cfg.copy()
    ...
    #check if it is carracing environment

    def iscarracing(self,state):
        expected_shape = (3, 96, 96)

        # Check if the observation space shape matches the expected shape
    ...
    def getV(self, obs):
        #obs = np.transpose(obs, (2, 0, 1))  # modified by YL
